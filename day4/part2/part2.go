...
// I literally just copy pasted my solution from part 1 and changed leastMovesNeeded from starting at infinity to starting at 0
// and flipped the leastMovesNeeded comparison LOL
...
func main() {
	...
	leastMovesNeeded, winnerScore := 0, 0
